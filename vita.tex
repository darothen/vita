...
career I studied the multi-facated role of aerosols in the climate system,
...
\item Instigatd and co-eveloped open-source, Python-based toolkits for accelerating the analysis of GEOS-Chem model output and working with legacy binary file formats in modern workflows
\end{itemize}
...
\begin{itemize}[itemindent=-10pt]
 ...
 \item \textbf{Rothenberg, Daniel}. Improved Forecasting Method with Machine Learning. \textit{Submitted}., October 31, 2019
