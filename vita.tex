...
Ph.D., Atmospheric Science, Dept. of Earth, Atmospheric and Planetary Sciences \rdate{February, 2017}
% {\small
%  \begin{itemize*}
...
Teaching Assistant
\begin{itemize}[itemindent=-10pt]
\item Moderated discussion forum for general-audience MOOC on climate science
\item Deployed single-column model to online cloud infrastructure for student problem set
\end{itemize}
% \newline

\textbf{Atmospheric Physics and Chemistry (12.806/12.306)} \rdate{\textsc{spring} 2014-2015} \newline
MIT, Department of Earth, Atmospheric, and Planetary Sciences \newline
Teaching Assistant\begin{itemize}[itemindent=-10pt]
\item Guest-lectured on aerosol and cloud microphysics modeling
\item Developed computational methods exercise to teach critical modeling and analysis skills
\end{itemize}
...
\begin{itemize}
  ...
  \item Steering Committee Member \rdate{2014-2015}
