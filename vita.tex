...
\begin{itemize}
  ...
  \item \textbf{High-Performance Computing} - Google Cloud Platform/Amazon Web Services; Multi-user clusters; NCAR supercomputers (bluefire/yellowstone/cheyenne); previously worked on NERSC and Oak Ridge systems
