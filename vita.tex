...
% 1. "Scalable Operational Artificial Intelligence Applications with Python." Joint session b/t Python and AI conferences, AMS Annual Meeting, Phoenix, AZ, 2019
% 2. "Augmented Weather Applications with Artificial Intelligence." AMS Washington Forum, Washington, D.C., 2019
...
\begin{itemize}[itemindent=-10pt]
  ...
  \item Managed a team of physical scientists, data scientists, and engineers across two offices conducting research and product development to support company initiatives
...
\mhead{Publications}%
 ...
 \item Silva, S., Ma, P.-L., Hardin, J., \textbf{Rothenberg, D.}: Physically Regularized Machine Learning Emulators of Aerosol Activatoin (\emph{in review})
...
\begin{itemize}[itemindent=-10pt]
 ...
 \item \textbf{Rothenberg, Daniel}. \href{https://patents.google.com/patent/US20200132884A1/en}{Improved Forecasting Method with Machine Learning}. US Patent US20200132884A1. April 30, 2020
...
\begin{itemize}
  ...
  \item \textbf{High-Performance Computing} - Google Cloud Platform/Amazon Web Services; Multi-user shared clusters; NCAR supercomputers (bluefire/yellowstone/cheyenne); previously worked on NERSC and Oak Ridge systems
...
\medskip
\mhead{Personal \newline Interests}%
Violin performance - classical (22 years),
Winter sports,
Backpacking/hiking,
