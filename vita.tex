...
\textbf{Pangeo-data}
\begin{itemize}
    \item Founding Member and Developer \rdate{2016}
\end{itemize}
...
\textbf{ClimaCell} \rdate{\textsc{Aug} 2017-\textsc{present}} \newline
\emph{Director of Meteorology}
\begin{itemize}[itemindent=-10pt]
    ...
    \item Managed a team of physical scientists conducting research and product development to support company business
...
\mhead{Publications}%
 ...
 \item Grandey, B. S., \textbf{Rothenberg, D.}, Avramov, A., Jin, Q., Lee, H., Wang, C.: Effective radiative forcing in the aerosol—climate model CAM5.3-
 MARC-ARG compared to default CAM5.3 (\emph{in prep})
 ...
 \item Jin, Q., Grandey, B. S., \textbf{Rothenberg, D.}, Avramov, A., Wang, C.: Impacts of Ship Emission Regulations, DMS Emissions, and Aerosol Mixing States on Cloud Radiative Effects of International Shipping Emissions (\emph{in prep})

 \item Tong, C. H. M., Yim, S., Chen, Y., Lau, N-C, \textbf{Rothenberg, D.}: Asessing the Impacts of Seasonal Atmospheric Conditions on Air Quality over the Pearl River Delta Region (\emph{in review})
