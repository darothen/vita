...
\def\myworkemail{} % \def\myworkemail{darothen@google.com}
...
\bigskip
\mhead{Honors \newline and \newline Awards}%
Editor's Award: \emph{Artifical Intelligence for the Earth Systems}, AMS \rdate{2026} \newline
...
\item Developed and analyzed large ensemble of IGSM/GEOS-Chem coupled climate-chemistry simulations to understand state-dependence of climate penalty calculations
...
\item Instigated and co-developed open-source, Python-based toolkits for accelerating the analysis of GEOS-Chem model output and working with legacy binary file formats in modern workflows
\end{itemize}
...
\bigskip
\mhead{Professional \newline Activities}
\textbf{AMS}, Early Career Leadership Academy, Kansas, City, MO \rdate{2022}\newline
\textbf{CMIP6 Hackathon}, NCAR, Boulder, CO \rdate{October, 2019} \newline
...
\href{https://www.ametsoc.org/index.cfm/ams/publications/journals/artificial-intelligence-for-the-earth-systems/}{\emph{Artificial Intelligence for the Earth Systems}}
\begin{itemize}
...
\begin{itemize}
	...
	\item Member, Session Chair \rdate{2011-2014}
\end{itemize}

Committee on Environmental Information Processing Technologies
\begin{itemize}
    \item Member, Python Symposium Committee \rdate{2018-2023}
\end{itemize}

Data Statement Drafting Committee
\begin{itemize}
    \item Member \rdate{2026}
\end{itemize}

AI Ethics and Policy Committee
\begin{itemize}
  \item Member \rdate{2025-\textsc{present}}
\end{itemize}

\medskip
\textbf{Reviewer}
\begin{itemize}
  \item Journal of Geophysical Research - Atmospheres \rdate{2015}
  \item Atmospheric Chemistry and Physics \rdate{2016-2022}
  \item IBM World Community Grid \rdate{2017}
  \item Journal of Climate \rdate{2018}
  \item The Journal of Open Source Education \rdate{2018}
  \item Proceedings of the National Academies of Science \rdate{2022}
  \item Weather and Forecasting \rdate{2024-2025}
  \item Artificial Intelligence for the Earth Systems \rdate{2024-2026}
  \item Nature \rdate{2025}
  \item Weather, Climate, and Society \rdate{2026}
\end{itemize}

\medskip
\textbf{Cornell Earth and Atmospheric Sciences Advisory Commitee}
\begin{itemize}
    \item Member \rdate{2026-\textsc{present}}
\end{itemize}

\medskip
\textbf{AI in ARM Advisory Group}
\begin{itemize}
    \item Member \rdate{2026-\textsc{present}}
\end{itemize}
...
\begin{itemize}
    \item Founding Member and Contributor \rdate{2016-\textsc{present}}
...
\textbf{\href{https://brightband.com}{Brightband}} \newline
...
\begin{itemize}[itemindent=-10pt]
	\item Oversaw the research, development, and implementation of a real-time, global, high-resolution precipitation observation system using commercial cellular microwave links, radars, and satellite datasets
  \item Managed and mentored a team of 2-6 physical scientists, data scientists, and engineers across multiple offices conducting research and product development to support company initiatives; group alumni have advanced their careers in atmospheric data science at CalTech, NOAA/CIRA, Indigo, Microsoft, and other high profile institutions/companies
	\item Established an internal applied research division (ClimaCell Labs) with a focus on develop AI-powered applications for applied weather analysis and forecasting; developed proposals for SBIR and other competitive federal funding programs sponsored by NOAA, NSF, and DOE
  \item Created and managed long-term research and development roadmaps aligned with emerging company business and strategic opportunities
  ...
  \item Developed and implemented a high-performance, Python-based quantitative precipitation nowcasting system optimized or performance on the cloud and deployed the model operationally (with >99.9\% SLA) to provide nowcasts based on radar and satellite-derived datasets for domains across the world
  \item Developed and prototyped a cloud-optimized, tera-scale geoscientific data archival system based on Pangeo stack (dask, Zarr, Intake, kubernetes) and curated over 100 TB of data from reanalysis (ERA-5), NWP (multi-year HRRR archive) and proprietary datasets 
\end{itemize}
...
% Nothing in prep at the moment
 \bigskip
 \emph{In Prep / Review}
 \medskip
 \begin{enumerate}[itemindent=-10pt]

 \item McGovern, A., Mandelbaum, T., \textbf{Rothenberg, D.}, Loveday, N., Potvin, C., Flora, M., Magnusson, L., Gilleland, E., Allen, J.: \href{https://arxiv.org/abs/2605.01126}{Extreme Weather Bench: A framework and benchmark for evaluation of high-impact weather}, arXiv. doi:10.48550/arXiv.2605.01126. 2026. \emph{In Review}
 ...
 \item Jin, Q., Grandey, B. S., \textbf{Rothenberg, D.}, Avramov, A., Wang, C.: \href{https://doi.org/10.5194/acp-18-16793-2018}{Impacts of Ship Emission Regulations, DMS Emissions, and Aerosol Mixing States on Cloud Radiative Effects of International Shipping Emissions}, Atmos. Chem. Phys., doi:10.5194/acp-18-16793-2018, 2018.
...
\item \href{https://github.com/brightbandtech/ExtremeWeatherBench}{ExtremeWeatherBench: Benchmarking of machine learning and numerical weather prediction (MLWP \& NWP) models}. doi: TBD. Last Updated: v0.2.0, December, 2025.

\item \href{https://github.com/darothen/superdroplet}{superdroplet: multi-language implementations of superdroplet models}. Last Updated: December, 2025 

\item \href{https://github.com/darothen/pyrcel}{pyrcel: cloud parcel model}. doi: \href{https://doi.org/10.5281/zenodo.163265}{10.5281/zenodo.163265}. Last Updated: v1.3.4, September, 2025.

\item \href{https://github.com/brightbandtech/nnja-ai}{nnja-ai: Find and load data from the Brightband AI-ready mirror of the NOAA NASA Joint Archive (NNJA) of Observations for Earth System Reanalysis}. doi: \href{https://doi.org/10.5281/zenodo.16749100}{10.5281/zenodo.16749100}. Last Updated: v1.0.0, August, 2025.
...
\begin{itemize}[itemindent=-10pt]
  ...
  % Not Included (yet) -
  % ESIP Federation Winter Meeting - re-give AMS talk
  % NASA GMAO Seminar (April, 2025)
  % NOAA AI4NWP Forum

 \item NOAA OAR AI Workshop, \textit{Invited Keynote Speaker}, June, 2026

 \item NCAR Postdoc Retreat, \textit{Panelist}, Boulder, CO, January, 2026
...
\begin{itemize}[itemindent=-10pt]
 ...
 \item McGovern, A. \textbf{et al}. \href{https://ams.confex.com/ams/106ANNUAL/meetingapp.cgi/Paper/477140}{ExtremeWeatherBench 1.0: A Flexible Evaluation Framework for Extreme Weather Events}. AMS Annual Meeting, Houston, 2026.
 
 \item Mandelbaum, T. \textbf{et al}. \href{https://ams.confex.com/ams/106ANNUAL/meetingapp.cgi/Paper/477141}{Applications of Extreme Weather Bench 1.0: Case Studies of High Impact Weather Events}. AMS Annual Meeting, Houston, Houston, 2026.

 \item Keisler, R. \textbf{et al}. \href{https://ams.confex.com/ams/106ANNUAL/meetingapp.cgi/Paper/473928}{AIDA: Operational AI Data Assimilation from Level 1 Observations}. AMS Annual Meeting, 2026.

 \item Mohrmann, H. \textbf{et al}. \href{https://ams.confex.com/ams/106ANNUAL/meetingapp.cgi/Paper/474971}{NNJA-AI v1: A Multi-modal, AI-ready Archive of Atmospheric Observations for ML Applications}. AMS Annual Meeting, Houston, 2026.

 \item Rothenberg, D. et al. \href{https://ams.confex.com/ams/106ANNUAL/meetingapp.cgi/Paper/476442}{Operationalizing Modular End-to-End Machine-Learning Data Assimilation and Weather Prediction Systems}. AMS Annual Meeting, Houston, 2026.

 \item McGovern, A., Mandelbaum, T., \textbf{Rothenberg, D.}. \href{https://meetingorganizer.copernicus.org/EGU26/EGU26-21878.html}{ExtremeWeatherBench 1.0: A Flexible Evaluation Framework for Extreme Weather Events}. EGU General Assembly 2026, Vienna, Austria, EGU26-21878, doi:10.5194/egusphere-egu26-21878, May, 2026.

 \item Ma, P.-L. \textbf{et al}. \href{https://doi.org/10.5194/egusphere-egu25-4600}{Advancing aerosols in Earth system modeling with artificial intelligence}. doi: \href{https://doi.org/10.5194/egusphere-egu25-4600}{10.5194/egusphere-egu25-4600} EGU General Assembly Conference Abstracts. Vienna, Austria. 2025.

 \item \textbf{Rothenberg, D.}, Minsk, J., Mohrmann, H., Keisler, R. \href{https://ams.confex.com/ams/105ANNUAL/meetingapp.cgi/Paper/452007}{A Multi-modal, AI-ready Dataset of Atmospheric Observations for ML Applications}. AMS Annual Meeting. New Orleans, LA, 2025.
 
 \item McGovern, A., \textbf{Rothenberg, D.}, Loveday, N., Potvin, C., Gilleland, E., Kim, L. \href{https://ams.confex.com/ams/105ANNUAL/meetingapp.cgi/Paper/451220}{Extreme Weather Bench}. AMS Annual Meeting. New Orleans, LA, 2025.
 
 \item Keisler, R., Dresdner, G., Bieker, J., Mohrmann, H., Rothenberg, D., Green, J. \href{https://ams.confex.com/ams/105ANNUAL/meetingapp.cgi/Paper/451380}{Observation-driven Machine Learning Forecasts of Global Weather}.  AMS Annual Meeting. New Orleans, LA, 2025.
...
\begin{itemize}[itemindent=-10pt]
 ...
 \item Research Frontiers in Machine Learning Weather Prediction. 26th Conference on Artificial Intelligence for Environmental Science. AMS Annual Meeting, Denver, CO, 2026.

 \item Advances and Innovation in Operational Machine Learning Weather Prediction. 26th Conference on Artificial Intelligence for Environmental Science. AMS Annual Meeting, Denver, CO, 2026.

 \item Data-Driven and Machine Learning Weather Prediction. 25th Conference on Artificial Intelligence for Environmental Science. AMS Annual Meeting, Houston, TX, 2026.

 \item Charting the Course of Artificial Intelligence for Weather Prediction: Where are we Today and Where are We Going?. Presidential Conference, AMS Annual Meeting, New Orleans, LA, 2025.

 \item Data-Driven Weather Modeling. 24th Conference on Artificial Intelligence for Environmental Science. AMS Annual Meeting, New Orleans, LA, 2025.
...
\bigskip
\emph{Grants and Proposals}
\medskip
\begin{itemize}[itemindent=-10pt]

 \item \href{https://techpartnerships.noaa.gov/tpo_partnership/making-observation-data-ai-ready/}{Making Observation Data AI-Ready}. NOAA CRADA between Brightband, NOAA PSL, and NOAA GSL. November, 2024.
...
\medskip
\mhead{Personal \newline Interests}%
Violin performance - classical (28 years),
Winter sports,
Backpacking/hiking,
